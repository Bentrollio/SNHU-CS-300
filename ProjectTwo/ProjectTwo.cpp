...
/**
 * TEST function to double-check my tree is balanced, not implemented in menu!
 ...
 * Recursively calls itself so that the lower and higher parts of the vector are inserted into the tree,
